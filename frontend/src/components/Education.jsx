...
import { SiLeetcode, SiGeeksforgeeks, SiCodeforces, SiHashnode } from "react-icons/si";
      ...
      >
        ...
        <motion.div className="timeline-item" variants={itemVariants}>
          ...
          <div className="timeline-content">
            ...
            <p>
              Writing about web development, problem-solving, and project experiences.
            </p>
            <div className="coding-links">
              <a
                href="https://vibha07.hashnode.dev/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <SiHashnode />
